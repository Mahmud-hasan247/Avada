...
!(function (e, t) {
  ...
  function S(e, t, n) {
    ...
    if (i <= 0 || null == i) {
      if ((((i = w(e, t, o)) < 0 || null == i) && (i = e.style[t]), ze.test(i)))
        return i;
    ...
    (function (e) {
      ...
      (t.attr = function (e, t) {
        ...
        var n = x.attrHandle[t.toLowerCase()],
          r =
            n && V.call(x.attrHandle, t.toLowerCase())
              ? n(e, t, !F)
              : undefined;
        return r !== undefined
          ? r
  ...
  (Market.Helpers.GaLsUtils = {
    getClientId: function () {
      ...
      return e
        ? e.match(/\d*\.\d*$/)[0]
        : localStorage.getItem(this.clientIdLocalStorageKey());
    },
  ...
  function (e) {
    ...
    for (
      var re,
        ...
        $e = /([\+\-]|\d\d)/gi,
        ze = "Date|Hours|Minutes|Seconds|Milliseconds".split("|"),
        We = {
          Milliseconds: 1,
          Seconds: 1e3,
          Minutes: 6e4,
    ...
    for (
      ...
      K(ze[ie].toLowerCase().replace(/s$/, ""), ze[ie]);
